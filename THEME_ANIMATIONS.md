...
- [THEME_ANIMATIONS.md](rules/THEME_ANIMATIONS.md) - 动画参数详细说明
- [THEME_ANIMATIONS_QUICKREF.md](rules/THEME_ANIMATIONS_QUICKREF.md) - 快速参考
- [THEMES.md](rules/THEMES.md) - 主题视觉配置
