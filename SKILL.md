...
### 批量处理（Feishu Base）
- [references/generate-docs-html-table-bug.md](references/generate-docs-html-table-bug.md) — `generate_docs.js` 中文提取失败：HTML 表格污染 narration.txt 的完整复现和验证方案
...
### 历史记录
- [references/CHANGELOG.md](references/CHANGELOG.md) — 演进历史（v5.x大修订；TTS实测修正；Remotion Native成功）
